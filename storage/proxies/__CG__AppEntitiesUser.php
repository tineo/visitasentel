...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'email', 'password', '' . "\0" . 'App\\Entities\\User' . "\0" . 'created_at', '' . "\0" . 'App\\Entities\\User' . "\0" . 'updated_at', 'fillable', 'hidden', 'rememberToken'];
        }

        return ['__isInitialized__', 'id', 'email', 'password', '' . "\0" . 'App\\Entities\\User' . "\0" . 'created_at', '' . "\0" . 'App\\Entities\\User' . "\0" . 'updated_at', 'fillable', 'hidden', 'rememberToken'];
    }
