 ...
 */
class Config extends \App\Entities\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Config' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Config' . "\0" . 'tag', '' . "\0" . 'App\\Entities\\Config' . "\0" . 'value'];
        }
